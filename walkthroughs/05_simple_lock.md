...
We have successfully created and executed the Custom Lock Script project. This project compiles a custom smart contract written in TypeScript down to CKB JS-VM bytecode (.bc), deploys it, locks cells under it, and runs two validation test cases (valid and invalid preimage secrets) live on CKB.
...
* src/index.ts: The loader and tester dApp:
  ...
  * Part 2 (Lock): Creates a new cell locked under our custom lock (code hash = JS-VM codeHash, args = JS-VM prefix + contract cell dataHash + hash of our passcode "NgocPassphrase123").
...
2. Part 2 (Lock):
   ...
   * Locked a new 150 CKB cell under our custom Lock Script.
